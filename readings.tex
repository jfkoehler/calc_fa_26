...
Preface to the English Edition and the opening section of
Part I, ``The Nature of the Infinite Process.''
\parencite{toeplitz1963}
...
What problem with the usual presentation of calculus is he trying
to address?

\item[\textcolor{LangRed}{CONNECT}]
Choose one mathematical idea from our opening problems.
How did that idea emerge from a problem, construction, or experiment
rather than from a definition or formula?

\item[\textcolor{LangRed}{QUESTION}]
Identify one claim Toeplitz makes about how mathematics should be
learned or presented. What do you find convincing, questionable,
or unresolved about that claim?
...
\courselabel{Representation, attention, and machine vision}

\textbf{Ashish Vaswani et al.,
``Attention Is All You Need.''}

Selected passages and diagrams introducing embeddings,
...
\item[\textcolor{LangRed}{READ}]
What mathematical objects enter a Transformer?
What operation does attention perform on a collection of
representations?

What changes, for Paglen, when images and representations circulate
primarily among machines rather than between images and human viewers?

\item[\textcolor{LangRed}{CONNECT}]
Trace two related transformations:
...
Where do the mathematical ideas we have studied this semester
appear in these processes?

\item[\textcolor{LangRed}{QUESTION}]
When we say that a model ``attends'' to something, what mathematical
operation are we describing?

What is gained by this language, and what might it encourage us to
imagine about the machine that is not contained in the mathematics?
